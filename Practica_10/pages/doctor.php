...
<body>
    ...
    <div class="row h-100 m-0">
        <main class="col mb-5 p-3 overflow-auto">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                <div class="d-flex flex-column flex-md-row gap-2 w-100">
                    ...
                    <div class="flex-fill">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Buscar médico..." id="buscar_medico" oninput="aplicarFiltrosMedicos()">
                            <button class="btn btn-outline-secondary" type="button" onclick="aplicarFiltrosMedicos()">
                    ...
                    <div class="d-flex gap-2">
                        <select class="form-select filtro-categoria" style="min-width: 150px;" id="filtro-estatus-medico" onchange="aplicarFiltrosMedicos()">
                        ...
                        <select class="form-select filtro-categoria" style="min-width: 160px;" id="ordenar-medicos" onchange="aplicarFiltrosMedicos()">
                            ...
                            <option value="fecha-ingreso-asc">Ingreso ↑</option>
                            <option value="fecha-ingreso-desc">Ingreso ↓</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="flex-shrink-0">
                    <button class="btn btn-primary btn-lg" onclick="mostrarRegistroMedico()">
        ...
        <!-- Modal de registro o edición de Médico -->
        <div id="registro_Medico" class="modal fade" tabindex="-1" aria-labelledby="modal_titulo_medico" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="form_Medico">
                            ...
                            <div class="d-flex align-items-stretch w-100 gap-3 mb-2">
                                <div class="flex-fill">
                                    <div class="form-floating"> 
                                        <input type="text" class="form-control" id="nombre_medico" placeholder="">
                                        <label for="nombre_medico" class="form-label">Nombre Completo</label>
                                    </div>
                                </div>
                                <div class="flex-fill">
                                    <div class="form-floating"> 
                                        <input type="text" class="form-control" id="cedula_medico" placeholder="">
                                        <label for="cedula_medico" class="form-label">Cédula Profesional</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-stretch w-100 gap-3 mb-2">
                                <div class="flex-fill">
                                    <div class="form-floating"> 
                                        <input type="tel" class="form-control" id="telefono_medico" placeholder="">
                                        <label for="telefono_medico" class="form-label">Teléfono</label>
                                    </div>
                                </div>
                                <div class="flex-fill">
                                    <div class="form-floating"> 
                                        <input type="email" class="form-control" id="correo_medico" placeholder="">
                                        <label for="correo_medico" class="form-label">Correo Electrónico</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select" id="horario_medico">
                                            <option value="" selected disabled></option>
                                            <option value="matutino">Matutino</option>
                                            <option value="vespertino">Vespertino</option>
                                            <option value="completo">Tiempo Completo</option>
                                        </select>
                                        <label for="horario_medico" class="form-label">Horario</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="estatus_medico_form">
                                    <option value="activo" selected>Activo</option>
                                    <option value="inactivo">Inactivo</option>
                                </select>
                                <label for="estatus_medico_form" class="form-label">Estatus</label>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="guardarMedico()">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
